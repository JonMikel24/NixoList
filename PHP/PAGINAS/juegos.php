...
<div class="container">
    <h2 style="text-align: center; margin-top: 20px;">🎮 Zona Arcade NixoList 🎮</h2>
    ...
    <div class="juegos-grid">
        <div class="juego-card">
            ...
            <p>Escucha un fragmento de audio y adivina a qué anime pertenece.</p>
        ...
        <div class="juego-card">
            <h3>🟩 Wordle Anime</h3>
            <p>Adivina el personaje de anime de 5 letras en 6 intentos.</p>
